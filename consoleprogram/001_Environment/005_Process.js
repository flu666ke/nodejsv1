...
// Этот объект предоставляет информацию и позволяет управлять текущем процессом

// Свойство хранит информацию о архитектуре процессора
console.log(process.arch)
// Свойство хранит путь по которому запускается Node js, путь по которому находиться исполняемый файл, и аргументы командной строки при запуске приложения 
console.log(process.argv)
// возвращает путь к серверу
...
//  external: 49879     - память используемая внешими библиотеками
// }
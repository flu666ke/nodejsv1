...
http.createServer(function (req, res) {
    // для работы с куками модуль cookies необходимо создать объект куки
    ...
    var cookieOptions = {
        ...
        // expires : (Date.now() + 7).toLocalString(),
    ...
    // Используя модуль cookies можно конфигурировать куки дополнительными параметрами, для этого в метод set нужно передать дополнительный объект
